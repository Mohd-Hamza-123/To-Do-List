...
const add_button = document.getElementById('search_bar_button');
let add_button_textContent = add_button.textContent;
const bottom = document.querySelector('.bottom');
let edit_icon;
...
let persist_key_value = localStorage.getItem('user');
persist_key_value_fun();
function persist_key_value_fun() {
    if (persist_key_value !== null) {

        key_value = JSON.parse(persist_key_value);
    }
}
...
>>>>>>> 5e1335c5c29c513ebef2cdb70dbda52534313ccd
